...
// Pass values directly to bypass SDK validation issue
const apiKey = process.env.CIRCLE_API_KEY;
const entitySecret = process.env.ENTITY_SECRET;

console.log("API Key loaded:", apiKey ? "yes" : "no");
console.log("Entity Secret loaded:", entitySecret ? "yes" : "no");

const ciphertext = generateEntitySecretCiphertext(
  entitySecret,
   '-----BEGIN PUBLIC KEY-----\n' +
